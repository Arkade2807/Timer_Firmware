...
#define JOYSTICK_THRESH_X_LEFT_2P7V   0xD175
#define JOYSTICK_THRESH_X_RIGHT_0P6V  0x2E8C
#define JOYSTICK_THRESH_Y_UP_2P7V     0xD175
#define JOYSTICK_THRESH_Y_DOWN_0P6V   0x2E8C
